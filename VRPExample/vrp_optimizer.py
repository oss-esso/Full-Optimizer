            ...
            if has_capacity_constraints:
                ...
                if is_ride_pooling and pickup_deliveries:
                    for pickup_idx, delivery_idx in pickup_deliveries:
                        ...
                        )                  # Add constraint to limit maximum driving hours per vehicle (10 hours)                if is_ride_pooling:                    # Use 50 km/h average speed for time estimation
                    ...
                    time_calculations_logged = 0
                      # Create a proper time dimension that includes both travel time and service time
                    ...
                    routing.AddDimension(
                        time_callback_index,
                        1800,  # slack time (30 minutes in seconds)
                    ...
                    # Ensure vehicles don't exceed time limits
