...
def test_both_implementations():
    ...
    try:
        ...
        import VRPExample.vrp_multiday_sequential_old as vrp_multiday_sequential_old
        
        original_vrp = vrp_multiday_sequential_old.SequentialMultiDayVRP(vehicles, locations)
